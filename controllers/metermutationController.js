      ...
      const mailOptions = {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <h2 style="color: #4C91CA;">Dear ${user.firstName},</h2>
            <p>Your application with ID <strong>${application.id}</strong> has been updated.</p>
            ...
            <div style="background-color: #4C91CA; color: #fff; text-align: center; padding: 10px; margin-top: 20px; border-radius: 5px;">
              <p style="margin: 0;">© 2024 WasacGroup. All rights reserved.</p>
            </div>
          </div>
        `,
        attachments: [{
          filename: 'Wasaclogo.png',
          path: 'controllers/WasacGroupLogo1.png', // Ensure this is the correct path to your logo
