...
const auth = async (req, res, next) => {
  ...
  try {
    ...
    // Attach the user object to req.user, including firstName, lastName, and nationalId
    req.user = {
      id: user.id,
      email: user.email,
      ...
      firstName: user.firstName,       // Include firstName from the database
      lastName: user.lastName,         // Include lastName from the database
    };
